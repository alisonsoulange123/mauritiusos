...
export const SESSION_COOKIE = 'reef_technologies_session';
export const REFRESH_COOKIE = 'reef_technologies_refresh';

/**
 * `sameSite: 'lax'` is a CSRF control, not a default.
 *
 * The proxy authenticates by cookie, so without it any site could POST to
 * `/api/reef-technologies/*` and have the browser attach this session. Lax withholds
