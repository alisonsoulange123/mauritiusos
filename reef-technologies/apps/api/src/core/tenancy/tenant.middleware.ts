 ...
 *   1. Host          portal.mauritius.reef_technologies.io
 *   2. X-Reef Technologies-Tenant header (trusted service-to-service calls only)
...
export class TenantMiddleware implements NestMiddleware {
  ...
  async use(request: Request, response: Response, next: NextFunction): Promise<void> {
    ...
    const slugFromHeader = request.headers['x-reef-technologies-tenant'] as string | undefined;
