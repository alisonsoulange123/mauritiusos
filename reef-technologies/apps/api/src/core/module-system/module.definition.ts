...
import type { ContractToken, EventName, ModuleKey } from '@reef-technologies/contracts';
 ...
 */
export interface ReefTechnologiesModuleDefinition {
...
export const MODULE_MANIFEST = Symbol.for('reef_technologies.core.ModuleManifest');
 ...
 */
export const defineModule = (definition: ReefTechnologiesModuleDefinition): ReefTechnologiesModuleDefinition =>
  definition;
