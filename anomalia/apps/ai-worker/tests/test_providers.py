...
from anomalia_ai.providers.hashing import (
...
class TestEventBusTimings:
    def test_socket_timeout_outlives_the_blocking_read(self) -> None:
        ...
        """
        from anomalia_ai.core.events import _BLOCK_MS, _SOCKET_TIMEOUT_SECONDS
...
class TestEventContract:
    def test_finds_the_generated_contract(self) -> None:
        ...
        """
        from anomalia_ai.core.events import find_contracts_path
    ...
    def test_knows_the_events_this_worker_subscribes_to(self) -> None:
        from anomalia_ai.core.events import load_event_names
