...
export function emailVerificationEmail(input: RecoveryMailInput): MailBody {
  ...
  const copy = {
    en: {
      ...
      lead: 'Confirm the address you used to create your ANOMALIA account.',
    ...
    fr: {
      ...
      lead: "Confirmez l'adresse utilisée pour créer votre compte ANOMALIA.",
...
export function passwordResetEmail(input: RecoveryMailInput): MailBody {
  ...
  const copy = {
    en: {
      ...
      lead: 'Someone asked to reset the password on your ANOMALIA account.',
    ...
    fr: {
      ...
      lead: "Une réinitialisation du mot de passe de votre compte ANOMALIA a été demandée.",
...
export function passwordChangedEmail(input: { link: string; locale: string }): MailBody {
  ...
  const copy = {
    en: {
      ...
      lead: 'The password on your ANOMALIA account was changed, and every signed-in device was signed out.',
    ...
    fr: {
      ...
      lead: "Le mot de passe de votre compte ANOMALIA a été modifié et tous les appareils connectés ont été déconnectés.",
...
<html><body style="margin:0;padding:32px 16px;background:#faf9f7;font-family:-apple-system,Segoe UI,Helvetica,Arial,sans-serif;color:#1a1a1a">
  <div style="max-width:480px;margin:0 auto">
    <p style="margin:0 0 32px;font-size:12px;letter-spacing:0.18em;text-transform:uppercase;color:#6b6b6b">ANOMALIA</p>
