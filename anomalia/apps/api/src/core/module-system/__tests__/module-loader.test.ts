...
import { contractToken, type ModuleKey } from '@anomalia/contracts';
import { flagNameFor } from '@anomalia/config';
import { loadModules, ModuleLoadError } from '../module-loader.js';
import type { AnomaliaModuleDefinition } from '../module.definition.js';
...
const mod = (
  key: ModuleKey,
  extra: Partial<AnomaliaModuleDefinition> = {},
): AnomaliaModuleDefinition => ({
  key,
  version: '1.0.0',
