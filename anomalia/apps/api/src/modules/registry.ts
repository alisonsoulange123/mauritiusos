 ...
 *   2. Add its key to MODULE_KEYS in `@anomalia/contracts`.
 ...
 */
import type { AnomaliaModuleDefinition } from '../core/module-system/module.definition.js';
...
export const MODULE_REGISTRY: readonly AnomaliaModuleDefinition[] = [
  // ── Platform floor ──────────────────────────────────────────────────────
  identity,
