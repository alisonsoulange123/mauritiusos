import { apiErrorSchema, type ApiError } from '@anomalia/contracts';
 ...
 */
const BROWSER_PROXY = '/api/anomalia';
...
function buildInit(options: RequestOptions, onServer: boolean): RequestInit {
  ...
  return {
    ...
    headers: {
      ...
      'x-anomalia-tenant': tenant ?? clientEnv.NEXT_PUBLIC_DEFAULT_TENANT,
