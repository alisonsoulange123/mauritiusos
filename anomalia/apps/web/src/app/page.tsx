  ...
  return (
    <>
      <Hero
        ...
        standfirst="Most relocation advice is either a forum post or a €400 consultation. ANOMALIA sits between them: verified rules, a decision engine that shows its reasoning, and an AI concierge that cites its sources."
