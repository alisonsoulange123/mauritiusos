...
export const coreEnvSchema = z.object({
  ...
  APP_NAME: z.string().default('anomalia-api'),
  ...
  EVENT_STREAM_PREFIX: z.string().default('anomalia:events'),
  EVENT_CONSUMER_GROUP: z.string().default('anomalia-api'),
  ...
  STORAGE_BUCKET: z.string().default('anomalia-documents'),
