 ...
 *     legal cross-module surface is `@anomalia/contracts`.
        ...
        patterns: [
          {
            ...
            message:
              'Cross-module deep imports are forbidden. Communicate via the EventBus or a ContractToken from @anomalia/contracts.',
          },
        ],
      },
    ],
